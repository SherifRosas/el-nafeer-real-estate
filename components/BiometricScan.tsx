        ...
        <div className="border border-white/10 rounded-[2rem] p-10 bg-black/60 backdrop-blur-3xl relative overflow-hidden group">
            ...
            <div className="flex flex-col items-center gap-8">
                ...
                <div className="text-center space-y-5 w-full px-4">
                    <p className="text-[10px] text-cyan-400/50 uppercase tracking-[0.4em] italic truncate">{status}</p>
                    <h2 className="text-xl lg:text-2xl font-black text-white italic tracking-[0.15em] uppercase leading-[1.8] break-words">
