...
export default function MetropolitanPortalPage() {
    return (
        <main className="w-screen h-screen bg-[#050811] overflow-hidden flex flex-col items-center justify-center p-8 relative">
          <div className="absolute inset-0 bg-gradient-to-b from-cyan-900/10 via-black to-black opacity-80" />
