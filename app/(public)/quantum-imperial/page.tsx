...
export default function AdMasterPage() {
  return (
    <>
      ...
      <div id="ssr-active-hud-layer" className="fixed left-1/2 -translate-x-1/2 top-[60px] z-[100000] w-[95%] max-w-[450px] px-4 flex justify-around items-center gap-4 transition-opacity duration-500">
          ...
          <a href="https://wa.me/201070615372" className="w-16 h-16 rounded-full bg-black/40 backdrop-blur-md border border-green-500/50 flex items-center justify-center shadow-[0_0_20px_rgba(34,197,94,0.3)]">
              <svg className="w-7 h-7 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
              </svg>
          </a>
          <a href="https://maps.app.goo.gl/r6vGf" className="w-16 h-16 rounded-full bg-black/40 backdrop-blur-md border border-[#c5a059]/50 flex items-center justify-center shadow-[0_0_20px_rgba(212,175,55,0.3)]">
      ...
      <div id="ssr-artwork-bg" className="fixed inset-0 z-[5] opacity-0 ssr-artwork-bg pointer-events-none flex items-center justify-center translate-y-[160px]">
