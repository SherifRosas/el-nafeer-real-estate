...
export default function AdMasterPage() {
  return (
    <>
      ...
      <div id="ssr-active-hud-layer" className="fixed left-1/2 -translate-x-1/2 top-[130px] sm:top-[200px] z-[100000] w-[95%] max-w-[450px] px-4 flex justify-around items-center gap-4 transition-opacity duration-500">
