  ...
  return (
    <>
      ...
      <div id="ssr-active-hud-layer" className="fixed left-1/2 -translate-x-1/2 top-[5vh] z-[100000] w-[95%] max-w-[450px] px-4 flex justify-around items-center gap-4 transition-opacity duration-500">
          <a href="tel:+201070615372" title="Call Us" className="w-16 h-16 rounded-full bg-black/40 backdrop-blur-md border border-cyan-500/50 flex items-center justify-center shadow-[0_0_20px_rgba(6,182,212,0.3)]">
              <svg className="w-7 h-7 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
          </a>
          <a href="https://wa.me/201070615372" title="WhatsApp" className="w-16 h-16 rounded-full bg-black/40 backdrop-blur-md border border-green-500/50 flex items-center justify-center shadow-[0_0_20px_rgba(34,197,94,0.3)]">
              <svg className="w-7 h-7 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
              </svg>
          </a>
          <a href="https://maps.app.goo.gl/r6vGf" title="Location" className="w-16 h-16 rounded-full bg-black/40 backdrop-blur-md border border-[#c5a059]/50 flex items-center justify-center shadow-[0_0_20px_rgba(212,175,55,0.3)]">
      ...
      {/* --- SSR MUTE RING (VISUAL CUE V110.13) --- */}
      <div 
          id="ssr-mute-ring" 
          className="fixed bottom-6 left-6 z-[100000] w-16 h-16 rounded-full bg-black/60 backdrop-blur-xl border-2 border-red-500/50 flex items-center justify-center animate-pulse cursor-pointer shadow-[0_0_20px_rgba(239,68,68,0.3)]"
      >
