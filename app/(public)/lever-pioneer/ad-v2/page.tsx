                ...
                <div onClick={startUltimaSequence} className="fixed inset-0 z-[1000] bg-black/98 flex flex-col items-center justify-center cursor-pointer overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                        <motion.div 
                            ...
                            className="absolute w-[320px] h-[320px] rounded-full border border-cyan-400/20 border-t-cyan-400/80 border-b-cyan-400/80"
                        />
                        <motion.div 
                            animate={{ rotate: -360 }}
                            transition={{ duration: 15, repeat: Infinity, ease: "linear" }}
                            className="absolute w-[350px] h-[350px] rounded-full border border-dashed border-cyan-400/10"
                        />
                        {[1, 2].map((i) => (
                            <motion.div 
                                key={`radar-${i}`}
                    ...
                    >
                        ...
                        <motion.div 
                            ...
                            className="w-64 h-64 relative rounded-full border-2 border-cyan-400/50 bg-white/95 backdrop-blur-xl p-6 shadow-2xl"
                        >
                            <NextImage 
                                src="/clients/lever-pioneer/logo_mimic.png" 
                                alt="Lever Pioneer" 
                                fill 
                                className="object-contain p-6 brightness-110 contrast-125"
                            />
                        </motion.div>

                        <div className="text-center space-y-10">
                             <div className="space-y-2">
                                <h1 className="text-white font-black text-4xl lg:text-5xl tracking-[0.3em] uppercase robotic-digits drop-shadow-[0_0_20px_rgba(255,255,255,0.4)]">SYSTEM_READY</h1>
                                <div className="h-[2px] w-64 mx-auto bg-gradient-to-r from-transparent via-cyan-400 to-transparent opacity-40" />
                             </div>
                             ...
                             <div className="flex flex-col items-center gap-4">
                                <motion.p 
                                    ...
                                    className="text-sahara-gold font-black text-xl lg:text-2xl tracking-widest uppercase"
                                >
                                    [ INITIATE BROADCAST ]
                                </motion.p>
                                <p className="text-cyan-400 font-bold text-xs robotic-digits uppercase tracking-[0.4em] opacity-60">
                                    ( Touch Logo to Finalize Link )
                                </p>
                             </div>
                        </div>
                    </motion.div>
                ...
                <div className="absolute inset-0 pointer-events-none z-50 p-6 lg:p-12 flex flex-col justify-between">
                     <div className="flex justify-between items-start text-cyan-400/40 text-[9px] robotic-digits tracking-[3px]">
                         <div className="flex gap-4 items-center">
                              ...
                              <span>LEVEL_15.5_HOLOGRAPH</span>
                         </div>
