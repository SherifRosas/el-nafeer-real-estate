...
export default function NarcoPage() {
  ...
  const localBusinessSchema = {
    ...
    "url": "https://el-nafeer-systems.vercel.app/حطب-أفريقي",
    "logo": "https://el-nafeer-systems.vercel.app/campaigns/narco/logo.jpg",
    "image": "https://el-nafeer-systems.vercel.app/campaigns/narco/logo.jpg",
    ...
    "itemListElement": [
      {
        ...
        "position": 1,
        "name": "الرئيسية",
        "item": "https://el-nafeer-systems.vercel.app"
      },
      {
        "@type": "ListItem",
        "position": 2,
        "name": "ناركو - حطب أفريقي",
        "item": "https://el-nafeer-systems.vercel.app/حطب-أفريقي"
      }
    ]
  };
